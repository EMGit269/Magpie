...
namespace Magpie.Host
{
    ...
    {
        // ── Backing Properties mapping to GrasshopperDocumentHost state ──
        private static string _cachedCanvasState { get => CachedCanvasState; set => CachedCanvasState = value; }
        private static string _cachedRhinoUnitSignature { get => CachedRhinoUnitSignature; set => CachedRhinoUnitSignature = value; }
        private static bool _canvasChanged { get => CanvasChanged; set => CanvasChanged = value; }
        private static Grasshopper.Kernel.GH_Document _publicIdBoundDocument { get => PublicIdBoundDocument; set => PublicIdBoundDocument = value; }
        private static Dictionary<Guid, string> _publicIdByGuid => PublicIdByGuid;
        private static Dictionary<string, Guid> _guidByPublicId => GuidByPublicId;
        private static int _nextComponentPublicId { get => NextComponentPublicId; set => NextComponentPublicId = value; }
        private static int _nextGroupPublicId { get => NextGroupPublicId; set => NextGroupPublicId = value; }
        ...
        public static string ExecuteGetCanvasSummary()
        {
        ...
        {
            if (CurrentLayoutMode != LayoutMode.CSharpFirst) return true;
        ...
        {
            error = null;
            if (CurrentLayoutMode != LayoutMode.CSharpFirst)
                return true;
        ...
        internal static string ExecuteSetGhComponentValue(string id, string value, double? min, double? max, int? decimals, string exactMember = null, string graphMapperType = null)
        {
            ...
            Rhino.RhinoApp.InvokeOnUiThread((Action)(() =>
            {
                ...
                if (CurrentLayoutMode == LayoutMode.CSharpFirst && IsCSharpScriptComponent(obj))
                {
        ...
        // ── Type Hint helpers moved from ChatWindow to keep host layer self-contained ──
        ...
        // ── Attachment MIME helper moved from ChatWindow to keep host layer self-contained ──
